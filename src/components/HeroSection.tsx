        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-neuro-dark">
              Domine a IA no RH antes que o mercado decida por você.
            </h1>
            <p className="text-lg md:text-xl text-gray-700 mb-10">
              Aprenda, do zero, como usar ChatGPT e outras ferramentas de IA para transformar
              processos de RH em algo estratégico, rápido e inteligente — sem precisar ser expert em tecnologia.
            </p>
            <Button 
